...
class CodeAgentService(code_agent_pb2_grpc.CodeAgentServicer):
    ...
    def FixIssue(self, request, context):
        ...
        try:
            ...
            github_pr_url = code_agent_impl.submit_pr(
                full_repo_name, issue_title, issue_body
            )
...
def serve():
    ...
    code_agent_pb2_grpc.add_CodeAgentServicer_to_server(CodeAgentService(), server)
    port = 50051
