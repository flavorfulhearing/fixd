...
const FileSchema = z.object({
    ...
    base64Content: z.string().describe("The full contents of a codebase file. This file is enocded in base64 as a utf-8 string."),
}).describe("A file in the codebase");
const CodebaseSchema = z.object({
    files: z.array(FileSchema).describe("An array of file changes that need to be made to fix the issue"),
...
const humanTemplate = "Here is my {codebase}. Here is the GitHub issue title: {issueTitle}. Here is the GitHub issue body: {issueBody}. Please return only the files that need to be changed, deleted, or created to fix the issue.";
